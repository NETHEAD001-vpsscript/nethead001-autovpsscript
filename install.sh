...
#
#  |════════════════════════════════════════════════════════════════════════════════════════════════════════════════|
#  • Autoscript AIO Lite Menu By nethead001 Project                                          |
#  • nethead001 Project Developer @Nethead001 | @Nethead001 | https://t.me/WORLDWILDINTERNETTECH |
#  • Copyright 2026 18 nethead001 Decode [  ] | [ @WORLDWILDINTERNETTECH ] | [ Pakistan ]       |
#  |════════════════════════════════════════════════════════════════════════════════════════════════════════════════|
#

link="https://raw.githubusercontent.com/NETHEAD001-vpsscript/nethead001-autovpsscript/refs/heads/main/install.sh"
clear
#echo "Port 22
Port 3303
...
#install latest xray
cd /usr/bin
wget -q https://raw.githubusercontent.com/Nethead001PutriFN/DindaPutriFN/main/api/xray.zip
...
commonname="Nethead001"
email="nethead001nethead001@gmail.com"
...
# Install Slowdns
cd
wget -q https://raw.githubusercontent.com/Nethead001PutriFN/Autoscript/main/slowdns.sh; chmod +x slowdns.sh; ./slowdns.sh; rm -fr slowdns.sh

# Install Chisel Proxy
cd
wget -q https://raw.githubusercontent.com/Nethead001PutriFN/Autoscript/main/chisel.sh; chmod +x chisel.sh; ./chisel.sh; rm -fr chisel.sh
...
cd /root; wget -O wgcf.sh "https://raw.githubusercontent.com/Nethead001PutriFN/warp/main/install-warp.sh"; chmod +x /root/*; /root/wgcf.sh; rm -fr /root/*

# Install Backup Google Drive
cd /root
wget https://raw.githubusercontent.com/Nethead001PutriFN/enhanced/main/set-br.sh
chmod +x /root/*
cd /root
./set-br.sh
rm -fr /root/*
...
#Install OpenVPN
cd
wget -q https://raw.githubusercontent.com/Nethead001PutriFN/DindaPutriFN/main/openvpn/vpn.sh && chmod +x vpn.sh && ./vpn.sh
...
wget -O /usr/bin/config.yaml "https://raw.githubusercontent.com/Nethead001PutriFN/FN-API/main/core/config.yaml"
...
wget -q -O /usr/bin/ws "https://raw.githubusercontent.com/Nethead001PutriFN/WebSocket-Proxy/main/ws.py"
...
wget -O /usr/bin/loop "https://raw.githubusercontent.com/Nethead001PutriFN/FN-API/main/core/quota.sh"
...
wget -O /usr/bin/server "https://raw.githubusercontent.com/Nethead001PutriFN/FN-API/main/core/server"
...
# Install HTTP Proxy
wget -O /usr/bin/http "https://raw.githubusercontent.com/Nethead001PutriFN/FN-API/main/core/http"
...
# Install OHP Server
wget -O /root/ohp.sh "https://raw.githubusercontent.com/Nethead001PutriFN/Autoscript/main/ohp.sh"
chmod +x /root/ohp.sh
cd /root
./ohp.sh
rm -fr /root/*
